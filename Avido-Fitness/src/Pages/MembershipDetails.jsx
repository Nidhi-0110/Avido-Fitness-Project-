...
import { MembershipDetailsData } from "../dummy/MembershipDetailsDummyData";
    ...
    <>
      <div className="main text-light px-5">
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="select-membership-text">
              <p className="select-membership-title mt-5">Select Membership </p>
            </div>
